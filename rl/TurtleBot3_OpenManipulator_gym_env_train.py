"""The goal is to train the turtlebot mobile robot to reach a target in an unknown environment while avoiding any obstacles"""
...
class GazeboTurtlebot3OpenManipulatorEnv(gazebo_env.GazeboEnv): # or class GazeboTurtlebot3OpenManipulatorEnv(gym.Env)
    def __init__(self):
        """ Env Variables """
        continuous = True
        ...
        gazebo_env.GazeboEnv.__init__(self, "competition.launch") # if gazebo_env.GazeboEnv
    ...
    def setReward(self, state, done, action):
        ...
        if self.get_goalbox:
            ...
            # delete current target and respawn
