...
ask(prompt)
print(colors.YELLOW + "Welcome to the ASPiDA ChatBot! I am ready to help you with your ASPiDA questions and commands.")

while True:
    question = input(colors.YELLOW + "ASPiDA> " + colors.ENDC)
